...
def calculates_results_stats(results_dic):
    ...
    """
    I set if conditions based on instructions:
    ...
    for key in results_dic:
        ...
        #check if pet label and classify label is matched so increment counter of matched labels since index 2 = where 1 = labels match
        if results_dic[key][2] == 1 and results_dic[key][3] == 1:
            results_stats_dic["n_correct_breed"] += 1
        
        # Pet Image Label is a Dog - counts number of dog images
        # check if pet label and classify label is matched and Pet Image Label is a dog so increment counter of correct breed  since index 2 = where 1 = labels match and index 3 =where 1= Pet Image Label is a dog 
    ...
    # we set this in if statement to not occuer error ZeroDivisionError
